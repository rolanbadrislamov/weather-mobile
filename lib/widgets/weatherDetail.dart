          ...
          Container(
            ...
            child: GridView(
              ...
              children: [
                ...
                _gridWeatherBuilder('${weatherProv.weather.tempMin.toStringAsFixed(1)}°C',
                    'Min', MdiIcons.thermometerLow),
                _gridWeatherBuilder('${weatherProv.weather.tempMax.toStringAsFixed(1)}°C',
                    'Max', MdiIcons.thermometerHigh),
              ],
            ),
          ),
        ],
